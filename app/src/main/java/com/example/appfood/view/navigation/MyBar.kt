    ...
    BottomNavigation(
        ...
        backgroundColor = colorResource(id = R.color.grey),
            ...
            Icon(
                ...
                modifier = Modifier.size(32.dp).clickable {navController.navigate("home")}
            )
            Icon(
                painter = painterResource(id = R.drawable.btn_2),
                contentDescription = "Shopping Cart",
                modifier = Modifier.size(32.dp).clickable {navController.navigate("cart_screen")}
            )
            Icon(
            ...
            Icon(
                ...
                modifier = Modifier.size(32.dp).clickable {navController.navigate("profile")},
            )
